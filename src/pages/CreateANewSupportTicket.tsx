...
import styles from "./CreateANewSupportTicket.module.css";
const CreateANewSupportTicket: FunctionComponent = () => {
  return (
            ...
            <div className={styles.textFieldParent}>
              <div className={styles.textField}>
                <div className={styles.value1}>
                  Enter Withdrawal Transaction ID
                </div>
              ...
              <div className={styles.viewLast5}>View Last 5 Withdrawals</div>
            </div>
                  ...
                  <div className={styles.textField1}>
                    ...
                    <div className={styles.valueContainer}>
                      <div className={styles.value4}>
                        I haven’t received my withdrawal amount in my bank
                        account yet. It’s been 3 days. Please resolve this ASAP.
                      </div>
                    </div>
                  </div>
                </div>
...
export default CreateANewSupportTicket;
