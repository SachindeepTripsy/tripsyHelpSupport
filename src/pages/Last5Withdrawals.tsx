...
import styles from "./Last5Withdrawals.module.css";
const Last5Withdrawals: FunctionComponent = () => {
  return (
    <div className={styles.last5Withdrawals}>
      <div className={styles.last5WithdrawalsInner}>
      ...
      <div className={styles.bottomSheetWrapper}>
        <div className={styles.bottomSheet}>
          <div className={styles.bottomSheetInner}>
            <div className={styles.last5WithdrawalsParent}>
              <div className={styles.last5Withdrawals1}>Last 5 Withdrawals</div>
              <div className={styles.plus2Wrapper}>
                <img className={styles.plus2Icon} alt="" src="/plus-21.svg" />
              </div>
            </div>
          </div>
          <div className={styles.bottomSheetChild} />
          <img
            className={styles.bottomSheetItem}
            alt=""
            src="/group-370871.svg"
          />
              ...
              <div className={styles.frameParent5}>
                <div className={styles.frameParent6}>
                  <div className={styles.parent}>
                    ...
                    <div className={styles.failed25}>
                      Failed · 25 Apr 2023, 12:09 PM
                    </div>
                  </div>
                  <div className={styles.transactionIdParent}>
                    <div className={styles.transactionId}>Transaction ID</div>
                    <div className={styles.uw20212241234236540811}>
                      UW20212241234236540811
                    </div>
                  </div>
                </div>
              ...
              <div className={styles.frameParent5}>
                <div className={styles.frameParent6}>
                  <div className={styles.parent}>
                    ...
                    <div className={styles.failed25}>
                      Success · 24 Apr 2023, 11:29 PM
                    </div>
                  </div>
                  <div className={styles.transactionIdParent}>
                    <div className={styles.transactionId}>Transaction ID</div>
                    <div className={styles.uw20212241234236540823}>
                      UW20212241234236540823
                    </div>
                  </div>
                </div>
                <div className={styles.selectWrapper}>
              ...
              <div className={styles.frameParent5}>
                <div className={styles.frameParent6}>
                  <div className={styles.parent}>
                    ...
                    <div className={styles.failed25}>
                      Success · 22 Apr 2023, 12:11 PM
                    </div>
                  </div>
                  <div className={styles.transactionIdParent}>
                    <div className={styles.transactionId}>Transaction ID</div>
                    <div className={styles.uw202122412342365408231}>
                      UW20212241234236540823
                    </div>
                  </div>
                </div>
              ...
              <div className={styles.frameParent5}>
                <div className={styles.frameParent6}>
                  <div className={styles.parent}>
                    ...
                    <div className={styles.failed25}>
                      Success · 25 Apr 2023, 12:09 PM
                    </div>
                  </div>
                  <div className={styles.transactionIdParent}>
                    <div className={styles.transactionId}>Transaction ID</div>
                    <div className={styles.uw20212241234236540811Wrapper}>
                      <div className={styles.uw202122412342365408111}>
                        UW20212241234236540811
                      </div>
                    </div>
                  </div>
            ...
            <div className={styles.frameWrapper5}>
              <div className={styles.frameWrapper4}>
                <div className={styles.frameWrapper7}>
                  <div className={styles.seeAllWithdrawalsWrapper}>
                    <div className={styles.submit}>See All Withdrawals</div>
                  </div>
                </div>
              </div>
            </div>
...
export default Last5Withdrawals;
